      ...
      <div className="page-body">
        ...
        <div className="page-footer">
          ...
          <div className="booking-info">
            ...
            <ol>
              <li><strong>Select Slot:</strong> Use the visualization to choose an available slot</li>
              <li><strong>Provide Details:</strong> Enter booking dates, times, and purpose</li>
              <li><strong>Submit Request:</strong> Your request will be pending admin approval</li>
              <li><strong>Confirmation:</strong> Admin will approve or reject your request</li>
              <li><strong>Use Slot:</strong> Once approved, use the slot during the booked time</li>
              <li><strong>Cancellation:</strong> Approved bookings can be cancelled if needed</li>
            </ol>
          </div>
          ...
          <div className="booking-rules">
            ...
            <ul>
              ...
              <li>Rejected bookings can be re-submitted with modifications</li>
            </ul>
          </div>
        </div>
      </div>
